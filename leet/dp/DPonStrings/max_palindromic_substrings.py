...
def solution2(s):
    ...
    for i in range(0, len(s)):
        ...
        # check if the expanded palindrome at i is expanding beyond the right boundary of current longest palindrome
        # at center c if it is, the new center is i
        if i + P[i] > r:
            c = i
            r = i + P[i]
    return P
