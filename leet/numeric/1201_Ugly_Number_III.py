...
# this solution is taken from https://leetcode.com/problems/ugly-number-iii/discuss/514893/Python-sol.-by-binary-search-and-set-theory.-80%2B-with-Hint-and-Comment
...
class Solution:
    ...
    def nthUglyNumber(self, n: int, a: int, b: int, c: int) -> int:
        ...
        def total_num_of_multiples(number, a, b, c):
            ...
            # This technique is called PIE (Principle of Inclusion/Exclusion)
            # Can be found in Levin textbook
            ab = lcm(a, b)
            bc = lcm(b, c)
            ac = lcm(a, c)
